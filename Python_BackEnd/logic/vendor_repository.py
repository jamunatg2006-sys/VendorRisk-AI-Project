...
class VendorRepository:
        ...
        try:
            cursor = conn.execute("""
                SELECT 
                    ...
                    MIN(vulnerabilities) as min_cves,
                    MAX(vulnerabilities) as max_cves
                FROM vendors 
    ...
    @classmethod
    def get_total_vendor_count(cls) -> int:
        ...
        try:
            cursor = conn.execute("SELECT COUNT(*) as count FROM vendors")
